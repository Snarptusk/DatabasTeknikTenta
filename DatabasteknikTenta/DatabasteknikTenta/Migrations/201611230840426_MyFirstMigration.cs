namespace DatabasteknikTenta.Migrations
{
    ...
    public partial class MyFirstMigration : DbMigration
    {
        public override void Up()
        {
            ...
            //CreateTable(
            //    "dbo.CustomerContactNameChanges",
            //    c => new
            //        {
            //            ContactNameChangeID = c.Int(nullable: false, identity: true),
            //            ContactID = c.String(nullable: false, unicode: false, storeType: "text"),
            //            OldName = c.String(nullable: false, unicode: false, storeType: "text"),
            //            NewName = c.String(nullable: false, unicode: false, storeType: "text"),
            //            ChangedDate = c.DateTime(nullable: false),
            //            UserId = c.Int(nullable: false),
            //        })
            //    .PrimaryKey(t => t.ContactNameChangeID);
            ...
            //CreateTable(
            //    "dbo.OrderDetailCount",
            //    c => new
            //        {
            //            Expr1 = c.Int(nullable: false),
            //            OrderID = c.Int(nullable: false),
            //            ProductID = c.Int(nullable: false),
            //            UnitPrice = c.Decimal(nullable: false, storeType: "money"),
            //            Quantity = c.Short(nullable: false),
            ...
            //            OrderDate = c.DateTime(),
            //        })
            //    .PrimaryKey(t => new { t.Expr1, t.OrderID, t.ProductID, t.UnitPrice, t.Quantity, t.Discount });
            ...
            //            Title = c.String(maxLength: 30),
            //        })
            //    .PrimaryKey(t => new { t.LastName, t.FirstName });
            ...
            //            UnitsInStock = c.Short(),
            //        })
            //    .PrimaryKey(t => new { t.CompanyName, t.ProductName, t.CategoryName });
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.OrderDetailCount");
            DropTable("dbo.Order Subtotals");
            DropTable("dbo.Order Details Extended");
            DropTable("dbo.Invoices");
            DropTable("dbo.CustomerContactNameChanges");
